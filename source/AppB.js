enyo.kind({
	...
	components:[
		{kind: "onyx.Toolbar", classes: "toolbar top", content: "Calcio Mercato Estate 2013 - Tutti i trasferimenti della Serie B"},
		{kind: "enyo.Scroller", fit: true, horizontal: "hidden", components: [
            { kind: "FittableRows", arrangerKind: "CollapsingArranger", classes: "vertical-padding panel container external", narrowFit: false, components: [
	    		...
	    		{name: "Chord", kind: "d3.Chord", width: 585, height: 585, onNodeLabel: "onnodelabel", onNodeText: "onnodetext", onChordLabel: "onchordlabel", onNodeMouseover: "onselectnode", onChordMouseover: "onselectchord", rotateGroups: 2, nodes: squadreB, matrix: cessioniB, details: trasferimentiB, classes: "vertical-padding"},
                {kind: "FittableColumns", components: [
		...
		{kind: "onyx.Toolbar", classes: "toolbar bottom", allowHtml: true, content: 
            ...
            + "Source: <a href=\"http://www.legaserieb.it/it\" target=\"_blank\">Lega Serie B</a>, "
            + "<a href=\"http://www.transfermarkt.it/it/serie-b/sommertransfers/wettbewerb_IT2.html\" target=\"_blank\">Transfermarkt.it</a> | "
    ...
    ontapcessioni: function(inSender,inEvent) {
        ...
        this.$.Chord.setMatrix(acquistiB);
        return true;
    },
    ontapacquisti: function(inSender,inEvent) {
        ...
        this.$.Chord.setMatrix(cessioniB);
        return true;
    },
