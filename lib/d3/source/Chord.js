enyo.kind({
    ...
    draw: function() {
        ...
        nodeText.filter(function(d, i) { return kind.d3.nodePath[0][i].getTotalLength() / 2 - 16 < this.getComputedTextLength(); })
                        .remove();
    ...
    redraw: function() {
        ...
        groupText.append("textPath")
            .attr("xlink:href", function(d, i) { return "#" + kind.id + "_group" + i; })
            .text(function(d, i) { return kind.nodes[i].name; });
        groupText.filter(function(d, i) { return kind.d3.nodePath[0][i].getTotalLength() / 2 - 16 < this.getComputedTextLength(); })
            .remove();
